...
public class FeesCalculatorBasisPathTest {
    ...
    public static Collection<Object[]> data() {
        return Arrays.asList(new Object[][] { 
            ...
            {9000, 90000, 100000, true, 9000 * 0.0005f},
	...
	@Test
    public void test() {
    	assertEquals(feePercentage, feeCalculator.calculateTransferFee(amount, fromAccountBalance, toAccountBalance, student), 0.5);
    }
